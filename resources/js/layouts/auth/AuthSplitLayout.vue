...
<template>
    <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div class="relative items-center justify-center hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
            ...
            <Link :href="route('home')" class="relative z-20 flex flex-col items-center text-3xl font-medium">
                <AppLogoIcon class="mr-2 size-[38rem] fill-current text-white mb-10" />
                {{ name }}
            </Link>
