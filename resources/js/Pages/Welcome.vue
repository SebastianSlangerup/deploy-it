            ...
            <main class="py-12">
                <section class="flex flex-col md:flex-row">
                    <div class="flex-1 flex flex-col items-center justify-center text-center pt-24 px-6 lg:px-24">
                        ...
                        <p class="text-lg text-[#76ABAE] max-w-2xl">
                            Deploy-it.dk helps you streamline the process of creating, managing, and scaling virtual
                            environments.
                            Our service reduces the dependency on expensive licenses while ensuring full functionality,
                            making it
                            easy for your development and DevOps teams to manage test, development, and production
                            environments
                            seamlessly.
                        </p>
                    </div>
                    <div class="flex-1 flex flex-col items-center justify-center">
                        <!-- SVG ref: https://cruip.com/laurel/ -->
                ...
                <section id="filler_section">
                    <!-- SVG ref: https://undraw.co/illustrations -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="17%" height="17%" class="mx-auto"
                        viewBox="0 0 583.04004 647.03484" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path
                        ...
                        <g>
                            <g>
                                <path id="uuid-ab5b4137-23bf-44b0-b8fd-0caecc79ac33-273"
                            ...
                            <path
                                ...
                                fill="#2f2e41" />
                            <path d="M273.61057,424.5l-1,31-39-7s16.74556-27.55905,14.37277-35.27954l25.62723,11.27954Z"
                                fill="#ffb6b6" />
                            <path
                            ...
                            <path
                                ...
                                fill="#2f2e41" />
                            <g>
                                <path id="uuid-9122ce6e-50cf-4901-97fd-d5a56bf7c6b1-274"
