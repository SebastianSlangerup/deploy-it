...
<template>
    <div>
        <a :href="route('contact')" class="fixed right-10 bottom-10 text-gray-700 bg-white rounded-full p-4 dark:bg-gray-700 dark:text-gray-300 hover:bg-gray-200 active:bg-gray-300 dark:hover:bg-gray-800 dark:active:bg-gray-900">
